...
// CircuitBreaker opens after threshold consecutive transport failures and stops
// allowing requests until the timeout elapses, then probes in half-open state.
