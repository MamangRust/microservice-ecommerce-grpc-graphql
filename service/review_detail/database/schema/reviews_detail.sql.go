...
func (q *Queries) CreateReviewDetail(ctx context.Context, arg CreateReviewDetailParams) (*CreateReviewDetailRow, error) {
	row := q.db.QueryRow(ctx, createReviewDetail,
		arg.ReviewID,
		arg.Type,
		arg.Url,
		arg.Caption,
	)
	var i CreateReviewDetailRow
	err := row.Scan(
		&i.ReviewDetailID,
		&i.ReviewID,
		&i.Type,
...
func (q *Queries) DeleteAllPermanentReviewDetails(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentReviewDetails)
	return err
}
...
func (q *Queries) DeletePermanentReviewDetail(ctx context.Context, reviewDetailID int32) error {
	_, err := q.db.Exec(ctx, deletePermanentReviewDetail, reviewDetailID)
	return err
}
...
func (q *Queries) GetReviewDetail(ctx context.Context, reviewDetailID int32) (*GetReviewDetailRow, error) {
	row := q.db.QueryRow(ctx, getReviewDetail, reviewDetailID)
...
func (q *Queries) GetReviewDetailTrashed(ctx context.Context, reviewDetailID int32) (*ReviewDetail, error) {
	row := q.db.QueryRow(ctx, getReviewDetailTrashed, reviewDetailID)
	var i ReviewDetail
	err := row.Scan(
		&i.ReviewDetailID,
		&i.ReviewID,
...
func (q *Queries) GetReviewDetails(ctx context.Context, arg GetReviewDetailsParams) ([]*GetReviewDetailsRow, error) {
	rows, err := q.db.Query(ctx, getReviewDetails, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetReviewDetailsActive(ctx context.Context, arg GetReviewDetailsActiveParams) ([]*GetReviewDetailsActiveRow, error) {
	rows, err := q.db.Query(ctx, getReviewDetailsActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetReviewDetailsTrashed(ctx context.Context, arg GetReviewDetailsTrashedParams) ([]*GetReviewDetailsTrashedRow, error) {
	rows, err := q.db.Query(ctx, getReviewDetailsTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllReviewDetails(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllReviewDetails)
	return err
}
...
func (q *Queries) RestoreReviewDetail(ctx context.Context, reviewDetailID int32) (*ReviewDetail, error) {
	row := q.db.QueryRow(ctx, restoreReviewDetail, reviewDetailID)
	var i ReviewDetail
	err := row.Scan(
		&i.ReviewDetailID,
		&i.ReviewID,
...
func (q *Queries) TrashReviewDetail(ctx context.Context, reviewDetailID int32) (*ReviewDetail, error) {
	row := q.db.QueryRow(ctx, trashReviewDetail, reviewDetailID)
	var i ReviewDetail
	err := row.Scan(
		&i.ReviewDetailID,
		&i.ReviewID,
...
func (q *Queries) UpdateReviewDetail(ctx context.Context, arg UpdateReviewDetailParams) (*UpdateReviewDetailRow, error) {
	row := q.db.QueryRow(ctx, updateReviewDetail,
		arg.Type,
		arg.Url,
		arg.Caption,
		arg.ReviewDetailID,
	)
	var i UpdateReviewDetailRow
	err := row.Scan(
		&i.ReviewDetailID,
		&i.ReviewID,
		&i.Type,
