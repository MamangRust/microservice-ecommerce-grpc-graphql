...
const deleteOrderItemsByOrderPermanent = `-- name: DeleteOrderItemsByOrderPermanent :exec
DELETE FROM order_items
WHERE
    order_id = $1
`
...
func (q *Queries) DeleteOrderItemsByOrderPermanent(ctx context.Context, orderID int32) error {
	_, err := q.db.Exec(ctx, deleteOrderItemsByOrderPermanent, orderID)
	return err
}
