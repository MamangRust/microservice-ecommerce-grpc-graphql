...
type Querier interface {
	...
	AdjustProductStock(ctx context.Context, arg AdjustProductStockParams) (*AdjustProductStockRow, error)
	...
	RestoreProduct(ctx context.Context, productID int32) (*RestoreProductRow, error)
	...
	TrashProduct(ctx context.Context, productID int32) (*TrashProductRow, error)
