...
func (q *Queries) AdjustProductStock(ctx context.Context, arg AdjustProductStockParams) (*AdjustProductStockRow, error) {
	row := q.db.QueryRow(ctx, adjustProductStock, arg.OperationID, arg.ProductID, arg.Delta)
	var i AdjustProductStockRow
	err := row.Scan(&i.ProductID, &i.CountInStock)
	return &i, err
}
...
func (q *Queries) RestoreProduct(ctx context.Context, productID int32) (*RestoreProductRow, error) {
	row := q.db.QueryRow(ctx, restoreProduct, productID)
	var i RestoreProductRow
	err := row.Scan(
		&i.ProductID,
		&i.MerchantID,
		&i.CategoryID,
...
func (q *Queries) TrashProduct(ctx context.Context, productID int32) (*TrashProductRow, error) {
	row := q.db.QueryRow(ctx, trashProduct, productID)
	var i TrashProductRow
	err := row.Scan(
		&i.ProductID,
		&i.MerchantID,
		&i.CategoryID,
