...
type Querier interface {
	...
	GetUserByEmailAndVerify(ctx context.Context, email string) (*GetUserByEmailAndVerifyRow, error)
	...
	GetUserByIdAndVerify(ctx context.Context, userID int32) (*GetUserByIdAndVerifyRow, error)
