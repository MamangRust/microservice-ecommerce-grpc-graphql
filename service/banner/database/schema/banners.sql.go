...
func (q *Queries) DeleteAllPermanentBanners(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentBanners)
	return err
}
...
func (q *Queries) DeleteBannerPermanently(ctx context.Context, bannerID int32) error {
	_, err := q.db.Exec(ctx, deleteBannerPermanently, bannerID)
	return err
}

const getBanner = `-- name: GetBanner :one
SELECT b.banner_id, b.name, b.start_date, b.end_date, b.start_time, b.end_time, b.is_active, b.created_at, b.updated_at
FROM banners b
WHERE
    banner_id = $1
...
func (q *Queries) GetBanner(ctx context.Context, bannerID int32) (*GetBannerRow, error) {
	row := q.db.QueryRow(ctx, getBanner, bannerID)
	var i GetBannerRow
	err := row.Scan(
		&i.BannerID,
		&i.Name,
...
func (q *Queries) GetBanners(ctx context.Context, arg GetBannersParams) ([]*GetBannersRow, error) {
	rows, err := q.db.Query(ctx, getBanners, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetBannersActive(ctx context.Context, arg GetBannersActiveParams) ([]*GetBannersActiveRow, error) {
	rows, err := q.db.Query(ctx, getBannersActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetBannersTrashed(ctx context.Context, arg GetBannersTrashedParams) ([]*GetBannersTrashedRow, error) {
	rows, err := q.db.Query(ctx, getBannersTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllBanners(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllBanners)
	return err
}
...
func (q *Queries) RestoreBanner(ctx context.Context, bannerID int32) (*Banner, error) {
	row := q.db.QueryRow(ctx, restoreBanner, bannerID)
	var i Banner
	err := row.Scan(
		&i.BannerID,
		&i.Name,
...
func (q *Queries) TrashBanner(ctx context.Context, bannerID int32) (*Banner, error) {
	row := q.db.QueryRow(ctx, trashBanner, bannerID)
	var i Banner
	err := row.Scan(
		&i.BannerID,
		&i.Name,
