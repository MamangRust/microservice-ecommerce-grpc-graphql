...
func (q *Queries) CreateMerchantSocialMediaLink(ctx context.Context, arg CreateMerchantSocialMediaLinkParams) (*CreateMerchantSocialMediaLinkRow, error) {
	row := q.db.QueryRow(ctx, createMerchantSocialMediaLink, arg.MerchantDetailID, arg.Platform, arg.Url)
	var i CreateMerchantSocialMediaLinkRow
	err := row.Scan(
		&i.MerchantSocialID,
		&i.MerchantDetailID,
		&i.Platform,
...
func (q *Queries) DeleteAllMerchantSocialMediaLinksPermanently(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllMerchantSocialMediaLinksPermanently)
	return err
}
...
func (q *Queries) DeleteMerchantSocialMediaLinkPermanently(ctx context.Context, merchantSocialID int32) error {
	_, err := q.db.Exec(ctx, deleteMerchantSocialMediaLinkPermanently, merchantSocialID)
	return err
}
...
func (q *Queries) RestoreAllMerchantSocialMediaLinks(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllMerchantSocialMediaLinks)
	return err
}
...
func (q *Queries) RestoreMerchantSocialMediaLink(ctx context.Context, merchantSocialID int32) (*MerchantSocialMediaLink, error) {
	row := q.db.QueryRow(ctx, restoreMerchantSocialMediaLink, merchantSocialID)
...
func (q *Queries) TrashMerchantSocialMediaLink(ctx context.Context, merchantSocialID int32) (*MerchantSocialMediaLink, error) {
	row := q.db.QueryRow(ctx, trashMerchantSocialMediaLink, merchantSocialID)
	var i MerchantSocialMediaLink
	err := row.Scan(
		&i.MerchantSocialID,
		&i.MerchantDetailID,
...
func (q *Queries) UpdateMerchantSocialMediaLink(ctx context.Context, arg UpdateMerchantSocialMediaLinkParams) (*UpdateMerchantSocialMediaLinkRow, error) {
	row := q.db.QueryRow(ctx, updateMerchantSocialMediaLink, arg.MerchantSocialID, arg.Platform, arg.Url)
	var i UpdateMerchantSocialMediaLinkRow
	err := row.Scan(
		&i.MerchantSocialID,
		&i.MerchantDetailID,
		&i.Platform,
