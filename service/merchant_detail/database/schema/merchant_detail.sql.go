...
func (q *Queries) CreateMerchantDetail(ctx context.Context, arg CreateMerchantDetailParams) (*CreateMerchantDetailRow, error) {
	row := q.db.QueryRow(ctx, createMerchantDetail,
		arg.MerchantID,
		arg.DisplayName,
		arg.CoverImageUrl,
		arg.LogoUrl,
...
func (q *Queries) DeleteAllPermanentMerchantDetails(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentMerchantDetails)
	return err
}
...
func (q *Queries) DeleteMerchantDetailPermanently(ctx context.Context, merchantDetailID int32) error {
	_, err := q.db.Exec(ctx, deleteMerchantDetailPermanently, merchantDetailID)
	return err
}
...
func (q *Queries) GetMerchantDetail(ctx context.Context, merchantDetailID int32) (*GetMerchantDetailRow, error) {
	row := q.db.QueryRow(ctx, getMerchantDetail, merchantDetailID)
...
func (q *Queries) GetMerchantDetailTrashed(ctx context.Context, merchantDetailID int32) (*GetMerchantDetailTrashedRow, error) {
	row := q.db.QueryRow(ctx, getMerchantDetailTrashed, merchantDetailID)
	var i GetMerchantDetailTrashedRow
	err := row.Scan(
		&i.MerchantDetailID,
		&i.MerchantID,
		&i.DisplayName,
...
func (q *Queries) GetMerchantDetails(ctx context.Context, arg GetMerchantDetailsParams) ([]*GetMerchantDetailsRow, error) {
	rows, err := q.db.Query(ctx, getMerchantDetails, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantDetailsActive(ctx context.Context, arg GetMerchantDetailsActiveParams) ([]*GetMerchantDetailsActiveRow, error) {
	rows, err := q.db.Query(ctx, getMerchantDetailsActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantDetailsTrashed(ctx context.Context, arg GetMerchantDetailsTrashedParams) ([]*GetMerchantDetailsTrashedRow, error) {
	rows, err := q.db.Query(ctx, getMerchantDetailsTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllMerchantDetails(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllMerchantDetails)
	return err
}
...
func (q *Queries) RestoreMerchantDetail(ctx context.Context, merchantDetailID int32) (*MerchantDetail, error) {
	row := q.db.QueryRow(ctx, restoreMerchantDetail, merchantDetailID)
...
func (q *Queries) TrashMerchantDetail(ctx context.Context, merchantDetailID int32) (*MerchantDetail, error) {
	row := q.db.QueryRow(ctx, trashMerchantDetail, merchantDetailID)
	var i MerchantDetail
	err := row.Scan(
		&i.MerchantDetailID,
		&i.MerchantID,
...
func (q *Queries) UpdateMerchantDetail(ctx context.Context, arg UpdateMerchantDetailParams) (*UpdateMerchantDetailRow, error) {
	row := q.db.QueryRow(ctx, updateMerchantDetail,
