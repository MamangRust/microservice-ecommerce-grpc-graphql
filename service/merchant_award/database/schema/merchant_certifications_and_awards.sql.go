...
func (q *Queries) CreateMerchantCertificationOrAward(ctx context.Context, arg CreateMerchantCertificationOrAwardParams) (*CreateMerchantCertificationOrAwardRow, error) {
	row := q.db.QueryRow(ctx, createMerchantCertificationOrAward,
		arg.MerchantID,
		arg.Title,
		arg.Description,
		arg.IssuedBy,
	...
	var i CreateMerchantCertificationOrAwardRow
	err := row.Scan(
...
func (q *Queries) DeleteAllPermanentMerchantCertificationsAndAwards(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentMerchantCertificationsAndAwards)
	return err
}
...
func (q *Queries) DeleteMerchantCertificationOrAwardPermanently(ctx context.Context, merchantCertificationID int32) error {
	_, err := q.db.Exec(ctx, deleteMerchantCertificationOrAwardPermanently, merchantCertificationID)
	return err
}
...
func (q *Queries) GetMerchantCertificationOrAward(ctx context.Context, merchantCertificationID int32) (*GetMerchantCertificationOrAwardRow, error) {
	row := q.db.QueryRow(ctx, getMerchantCertificationOrAward, merchantCertificationID)
	var i GetMerchantCertificationOrAwardRow
	err := row.Scan(
		&i.MerchantCertificationID,
		&i.MerchantID,
		&i.Title,
...
func (q *Queries) GetMerchantCertificationsAndAwards(ctx context.Context, arg GetMerchantCertificationsAndAwardsParams) ([]*GetMerchantCertificationsAndAwardsRow, error) {
	rows, err := q.db.Query(ctx, getMerchantCertificationsAndAwards, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantCertificationsAndAwardsActive(ctx context.Context, arg GetMerchantCertificationsAndAwardsActiveParams) ([]*GetMerchantCertificationsAndAwardsActiveRow, error) {
	rows, err := q.db.Query(ctx, getMerchantCertificationsAndAwardsActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantCertificationsAndAwardsTrashed(ctx context.Context, arg GetMerchantCertificationsAndAwardsTrashedParams) ([]*GetMerchantCertificationsAndAwardsTrashedRow, error) {
	rows, err := q.db.Query(ctx, getMerchantCertificationsAndAwardsTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllMerchantCertificationsAndAwards(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllMerchantCertificationsAndAwards)
	return err
}
...
func (q *Queries) RestoreMerchantCertificationOrAward(ctx context.Context, merchantCertificationID int32) (*MerchantCertificationsAndAward, error) {
	row := q.db.QueryRow(ctx, restoreMerchantCertificationOrAward, merchantCertificationID)
...
func (q *Queries) TrashMerchantCertificationOrAward(ctx context.Context, merchantCertificationID int32) (*MerchantCertificationsAndAward, error) {
	row := q.db.QueryRow(ctx, trashMerchantCertificationOrAward, merchantCertificationID)
	var i MerchantCertificationsAndAward
	err := row.Scan(
		&i.MerchantCertificationID,
		&i.MerchantID,
...
func (q *Queries) UpdateMerchantCertificationOrAward(ctx context.Context, arg UpdateMerchantCertificationOrAwardParams) (*UpdateMerchantCertificationOrAwardRow, error) {
	row := q.db.QueryRow(ctx, updateMerchantCertificationOrAward,
	...
	var i UpdateMerchantCertificationOrAwardRow
	err := row.Scan(
		&i.MerchantCertificationID,
		&i.MerchantID,
		&i.Title,
