...
func (r *userRepository) FindById(ctx context.Context, user_id int) (*dto.GetUserByIDRow, error) {
...
func (r *userRepository) FindByEmail(ctx context.Context, email string) (*dto.User, error) {
...
func (r *userRepository) FindByEmailAndVerify(ctx context.Context, email string) (*dto.GetUserByEmailAndVerifyRow, error) {
	...
	return &dto.GetUserByEmailAndVerifyRow{
		UserID:    res.Data.Id,
		Firstname: res.Data.Firstname,
		Lastname:  res.Data.Lastname,
		Email:     res.Data.Email,
...
func (r *userRepository) FindByVerificationCode(ctx context.Context, verification_code string) (*dto.GetUserByVerificationCodeRow, error) {
	res, err := r.queryClient.FindByVerificationCode(ctx, &pb.FindByVerificationCodeRequest{VerificationCode: verification_code})
	if err != nil {
		return nil, user_errors.ErrUserNotFound.WithInternal(err)
	}

	return &dto.GetUserByVerificationCodeRow{
		UserID:    res.Data.Id,
		Firstname: res.Data.Firstname,
		Lastname:  res.Data.Lastname,
		Email:     res.Data.Email,
...
func (r *userRepository) CreateUser(ctx context.Context, request *requests.RegisterRequest) (*dto.CreateUserRow, error) {
...
func (r *userRepository) UpdateUserIsVerified(ctx context.Context, user_id int, is_verified bool) (*dto.UpdateUserIsVerifiedRow, error) {
	...
	return &dto.UpdateUserIsVerifiedRow{
		UserID:    res.Data.Id,
		Firstname: res.Data.Firstname,
		Lastname:  res.Data.Lastname,
		Email:     res.Data.Email,
...
func (r *userRepository) UpdateUserPassword(ctx context.Context, user_id int, password string) (*dto.UpdateUserPasswordRow, error) {
	...
	return &dto.UpdateUserPasswordRow{
		UserID:    res.Data.Id,
		Firstname: res.Data.Firstname,
		Lastname:  res.Data.Lastname,
		Email:     res.Data.Email,
