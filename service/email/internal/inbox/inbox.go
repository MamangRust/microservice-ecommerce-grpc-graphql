...
import (
	...
	db "github.com/MamangRust/microservice-ecommerce-grpc-email/database/schema"
	"github.com/jackc/pgx/v5/pgxpool"
)

var ErrInvalidInboxKey = errors.New("invalid consumer inbox key")

// InboxExecutor is the generated DBTX contract of the email service's schema
// package. Using it here guarantees inbox persistence follows the same
// query-file/code-generation rule as the domain repositories.
...
// PostgresInbox adapts a pgx pool to the outbox.ConsumerInbox contract.
