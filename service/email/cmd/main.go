...
import (
	...
	"github.com/MamangRust/microservice-ecommerce-grpc-email/internal/config"
	"github.com/MamangRust/microservice-ecommerce-grpc-email/internal/handler"
	"github.com/MamangRust/microservice-ecommerce-grpc-email/internal/inbox"
	"github.com/MamangRust/microservice-ecommerce-grpc-email/internal/mailer"
	"github.com/MamangRust/microservice-ecommerce-grpc-email/internal/metrics"
	"github.com/MamangRust/microservice-ecommerce-pkg/database"
	"github.com/MamangRust/microservice-ecommerce-pkg/dotenv"
	"github.com/MamangRust/microservice-ecommerce-pkg/emailretry"
...
func main() {
	...
	inbox, err := inbox.NewPostgresInbox(dbPool)
	if err != nil {
