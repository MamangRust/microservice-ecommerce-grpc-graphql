...
func (q *Queries) CreateSlider(ctx context.Context, arg CreateSliderParams) (*CreateSliderRow, error) {
	row := q.db.QueryRow(ctx, createSlider, arg.Name, arg.Image)
	var i CreateSliderRow
	err := row.Scan(
		&i.SliderID,
		&i.Name,
		&i.Image,
...
func (q *Queries) DeleteAllPermanentSliders(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentSliders)
	return err
}
...
func (q *Queries) DeleteSliderPermanently(ctx context.Context, sliderID int32) error {
	_, err := q.db.Exec(ctx, deleteSliderPermanently, sliderID)
	return err
}
...
func (q *Queries) GetSliderByID(ctx context.Context, sliderID int32) (*GetSliderByIDRow, error) {
	row := q.db.QueryRow(ctx, getSliderByID, sliderID)
	var i GetSliderByIDRow
	err := row.Scan(
		&i.SliderID,
		&i.Name,
		&i.Image,
...
func (q *Queries) GetSliders(ctx context.Context, arg GetSlidersParams) ([]*GetSlidersRow, error) {
	rows, err := q.db.Query(ctx, getSliders, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetSlidersActive(ctx context.Context, arg GetSlidersActiveParams) ([]*GetSlidersActiveRow, error) {
	rows, err := q.db.Query(ctx, getSlidersActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetSlidersTrashed(ctx context.Context, arg GetSlidersTrashedParams) ([]*GetSlidersTrashedRow, error) {
	rows, err := q.db.Query(ctx, getSlidersTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllSliders(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllSliders)
	return err
}
...
func (q *Queries) RestoreSlider(ctx context.Context, sliderID int32) (*Slider, error) {
	row := q.db.QueryRow(ctx, restoreSlider, sliderID)
	var i Slider
	err := row.Scan(
		&i.SliderID,
		&i.Name,
...
func (q *Queries) TrashSlider(ctx context.Context, sliderID int32) (*Slider, error) {
	row := q.db.QueryRow(ctx, trashSlider, sliderID)
	var i Slider
	err := row.Scan(
		&i.SliderID,
		&i.Name,
...
func (q *Queries) UpdateSlider(ctx context.Context, arg UpdateSliderParams) (*UpdateSliderRow, error) {
	row := q.db.QueryRow(ctx, updateSlider, arg.SliderID, arg.Name, arg.Image)
	var i UpdateSliderRow
	err := row.Scan(
		&i.SliderID,
		&i.Name,
		&i.Image,
