...
func (q *Queries) DeleteAllPermanentReviews(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentReviews)
	return err
}
...
func (q *Queries) DeleteReviewPermanently(ctx context.Context, reviewID int32) error {
	_, err := q.db.Exec(ctx, deleteReviewPermanently, reviewID)
	return err
}
...
func (q *Queries) GetReviewByID(ctx context.Context, reviewID int32) (*GetReviewByIDRow, error) {
...
type GetReviewByMerchantIdRow struct {
	...
	ReviewDetails []byte           `json:"review_details"`
}
...
func (q *Queries) GetReviewByMerchantId(ctx context.Context, arg GetReviewByMerchantIdParams) ([]*GetReviewByMerchantIdRow, error) {
	rows, err := q.db.Query(ctx, getReviewByMerchantId,
		arg.Column1,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) GetReviewByProductId(ctx context.Context, arg GetReviewByProductIdParams) ([]*GetReviewByProductIdRow, error) {
	rows, err := q.db.Query(ctx, getReviewByProductId,
		arg.ProductID,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) GetReviews(ctx context.Context, arg GetReviewsParams) ([]*GetReviewsRow, error) {
	rows, err := q.db.Query(ctx, getReviews, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetReviewsActive(ctx context.Context, arg GetReviewsActiveParams) ([]*GetReviewsActiveRow, error) {
	rows, err := q.db.Query(ctx, getReviewsActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetReviewsTrashed(ctx context.Context, arg GetReviewsTrashedParams) ([]*GetReviewsTrashedRow, error) {
	rows, err := q.db.Query(ctx, getReviewsTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllReviews(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllReviews)
	return err
}
...
func (q *Queries) RestoreReview(ctx context.Context, reviewID int32) (*Review, error) {
	row := q.db.QueryRow(ctx, restoreReview, reviewID)
	var i Review
	err := row.Scan(
		&i.ReviewID,
		&i.UserID,
...
func (q *Queries) TrashReview(ctx context.Context, reviewID int32) (*Review, error) {
	row := q.db.QueryRow(ctx, trashReview, reviewID)
	var i Review
	err := row.Scan(
		&i.ReviewID,
		&i.UserID,
