...
func (q *Queries) CreateMerchantBusinessInformation(ctx context.Context, arg CreateMerchantBusinessInformationParams) (*CreateMerchantBusinessInformationRow, error) {
	row := q.db.QueryRow(ctx, createMerchantBusinessInformation,
		arg.MerchantID,
		arg.BusinessType,
		arg.TaxID,
		arg.EstablishedYear,
	...
	var i CreateMerchantBusinessInformationRow
	err := row.Scan(
...
func (q *Queries) DeleteAllPermanentMerchantBusinessInformation(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentMerchantBusinessInformation)
	return err
}
...
func (q *Queries) DeleteMerchantBusinessInformationPermanently(ctx context.Context, merchantBusinessInfoID int32) error {
	_, err := q.db.Exec(ctx, deleteMerchantBusinessInformationPermanently, merchantBusinessInfoID)
	return err
}
...
func (q *Queries) GetMerchantBusinessInformation(ctx context.Context, merchantBusinessInfoID int32) (*GetMerchantBusinessInformationRow, error) {
	row := q.db.QueryRow(ctx, getMerchantBusinessInformation, merchantBusinessInfoID)
	var i GetMerchantBusinessInformationRow
	err := row.Scan(
		&i.MerchantBusinessInfoID,
		&i.MerchantID,
		&i.BusinessType,
...
func (q *Queries) GetMerchantsBusinessInformation(ctx context.Context, arg GetMerchantsBusinessInformationParams) ([]*GetMerchantsBusinessInformationRow, error) {
	rows, err := q.db.Query(ctx, getMerchantsBusinessInformation, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantsBusinessInformationActive(ctx context.Context, arg GetMerchantsBusinessInformationActiveParams) ([]*GetMerchantsBusinessInformationActiveRow, error) {
	rows, err := q.db.Query(ctx, getMerchantsBusinessInformationActive, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantsBusinessInformationTrashed(ctx context.Context, arg GetMerchantsBusinessInformationTrashedParams) ([]*GetMerchantsBusinessInformationTrashedRow, error) {
	rows, err := q.db.Query(ctx, getMerchantsBusinessInformationTrashed, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllMerchantBusinessInformation(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllMerchantBusinessInformation)
	return err
}
...
func (q *Queries) RestoreMerchantBusinessInformation(ctx context.Context, merchantBusinessInfoID int32) (*MerchantBusinessInformation, error) {
	row := q.db.QueryRow(ctx, restoreMerchantBusinessInformation, merchantBusinessInfoID)
...
func (q *Queries) TrashMerchantBusinessInformation(ctx context.Context, merchantBusinessInfoID int32) (*MerchantBusinessInformation, error) {
	row := q.db.QueryRow(ctx, trashMerchantBusinessInformation, merchantBusinessInfoID)
	var i MerchantBusinessInformation
	err := row.Scan(
		&i.MerchantBusinessInfoID,
		&i.MerchantID,
...
func (q *Queries) UpdateMerchantBusinessInformation(ctx context.Context, arg UpdateMerchantBusinessInformationParams) (*UpdateMerchantBusinessInformationRow, error) {
	row := q.db.QueryRow(ctx, updateMerchantBusinessInformation,
	...
	var i UpdateMerchantBusinessInformationRow
	err := row.Scan(
		&i.MerchantBusinessInfoID,
		&i.MerchantID,
		&i.BusinessType,
