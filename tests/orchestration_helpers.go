...
import (
	...
	bannerdb "github.com/MamangRust/microservice-ecommerce-grpc-banner/database/schema"
	cartdb "github.com/MamangRust/microservice-ecommerce-grpc-cart/database/schema"
	categorydb "github.com/MamangRust/microservice-ecommerce-grpc-category/database/schema"
	merchantdb "github.com/MamangRust/microservice-ecommerce-grpc-merchant/database/schema"
	merchant_awarddb "github.com/MamangRust/microservice-ecommerce-grpc-merchant_award/database/schema"
	merchant_businessdb "github.com/MamangRust/microservice-ecommerce-grpc-merchant_business/database/schema"
	merchant_detaildb "github.com/MamangRust/microservice-ecommerce-grpc-merchant_detail/database/schema"
	merchant_policydb "github.com/MamangRust/microservice-ecommerce-grpc-merchant_policy/database/schema"
	order_itemdb "github.com/MamangRust/microservice-ecommerce-grpc-order-item/database/schema"
	orderdb "github.com/MamangRust/microservice-ecommerce-grpc-order/database/schema"
	productdb "github.com/MamangRust/microservice-ecommerce-grpc-product/database/schema"
	review_detaildb "github.com/MamangRust/microservice-ecommerce-grpc-review-detail/database/schema"
	reviewdb "github.com/MamangRust/microservice-ecommerce-grpc-review/database/schema"
	roledb "github.com/MamangRust/microservice-ecommerce-grpc-role/database/schema"
	shipping_addressdb "github.com/MamangRust/microservice-ecommerce-grpc-shipping-address/database/schema"
	sliderdb "github.com/MamangRust/microservice-ecommerce-grpc-slider/database/schema"
	transactiondb "github.com/MamangRust/microservice-ecommerce-grpc-transaction/database/schema"
...
func (s *BaseTestSuite) SetupRoleService() {
	...
	queries := roledb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupUserService() {
	cacheStore := s.GetCacheStore()
	queries := userdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupAuthService() {
	cacheStore := s.GetCacheStore()
	queries := authdb.New(s.ts.DBPool())
	hasher := hash.NewHashingPassword()
...
func (s *BaseTestSuite) SetupBannerService() {
	cacheStore := s.GetCacheStore()
	queries := bannerdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupSliderService() {
	cacheStore := s.GetCacheStore()
	queries := sliderdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupCategoryService() {
	cacheStore := s.GetCacheStore()
	queries := categorydb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupOrderService() {
	cacheStore := s.GetCacheStore()
	queries := orderdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupTransactionService() {
	cacheStore := s.GetCacheStore()
	queries := transactiondb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupShippingAddressService() {
	cacheStore := s.GetCacheStore()
	queries := shipping_addressdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupOrderItemService() {
	cacheStore := s.GetCacheStore()
	queries := order_itemdb.New(s.ts.DBPool())
...
func (s *BaseTestSuite) SetupReviewDetailService() {
	cacheStore := s.GetCacheStore()
	queries := review_detaildb.New(s.ts.DBPool())
