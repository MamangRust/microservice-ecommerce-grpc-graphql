...
const (
	RoleQueryService_FindAllRole_FullMethodName    = "/pb.RoleQueryService/FindAllRole"
	RoleQueryService_FindByIdRole_FullMethodName   = "/pb.RoleQueryService/FindByIdRole"
	RoleQueryService_FindByNameRole_FullMethodName = "/pb.RoleQueryService/FindByNameRole"
	RoleQueryService_FindByActive_FullMethodName   = "/pb.RoleQueryService/FindByActive"
	RoleQueryService_FindByTrashed_FullMethodName  = "/pb.RoleQueryService/FindByTrashed"
	RoleQueryService_FindByUserId_FullMethodName   = "/pb.RoleQueryService/FindByUserId"
)
...
func (UnimplementedRoleQueryServiceServer) FindByNameRole(context.Context, *FindByNameRoleRequest) (*ApiResponseRole, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByNameRole not implemented")
}
...
var RoleQueryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.RoleQueryService",
