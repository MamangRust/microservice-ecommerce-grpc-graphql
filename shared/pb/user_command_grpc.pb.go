...
const (
	UserCommandService_Create_FullMethodName                 = "/pb.UserCommandService/Create"
	UserCommandService_Update_FullMethodName                 = "/pb.UserCommandService/Update"
	UserCommandService_UpdateIsVerified_FullMethodName       = "/pb.UserCommandService/UpdateIsVerified"
	UserCommandService_UpdatePassword_FullMethodName         = "/pb.UserCommandService/UpdatePassword"
	UserCommandService_TrashedUser_FullMethodName            = "/pb.UserCommandService/TrashedUser"
	UserCommandService_RestoreUser_FullMethodName            = "/pb.UserCommandService/RestoreUser"
	UserCommandService_DeleteUserPermanent_FullMethodName    = "/pb.UserCommandService/DeleteUserPermanent"
	UserCommandService_RestoreAllUser_FullMethodName         = "/pb.UserCommandService/RestoreAllUser"
	UserCommandService_DeleteAllUserPermanent_FullMethodName = "/pb.UserCommandService/DeleteAllUserPermanent"
)
...
type UserCommandServiceClient interface {
	...
	UpdateIsVerified(ctx context.Context, in *UpdateUserIsVerifiedRequest, opts ...grpc.CallOption) (*ApiResponseUser, error)
	UpdatePassword(ctx context.Context, in *UpdateUserPasswordRequest, opts ...grpc.CallOption) (*ApiResponseUser, error)
...
func (c *userCommandServiceClient) UpdateIsVerified(ctx context.Context, in *UpdateUserIsVerifiedRequest, opts ...grpc.CallOption) (*ApiResponseUser, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseUser)
	err := c.cc.Invoke(ctx, UserCommandService_UpdateIsVerified_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userCommandServiceClient) UpdatePassword(ctx context.Context, in *UpdateUserPasswordRequest, opts ...grpc.CallOption) (*ApiResponseUser, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseUser)
	err := c.cc.Invoke(ctx, UserCommandService_UpdatePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserCommandServiceServer interface {
	...
	UpdateIsVerified(context.Context, *UpdateUserIsVerifiedRequest) (*ApiResponseUser, error)
	UpdatePassword(context.Context, *UpdateUserPasswordRequest) (*ApiResponseUser, error)
...
func (UnimplementedUserCommandServiceServer) UpdateIsVerified(context.Context, *UpdateUserIsVerifiedRequest) (*ApiResponseUser, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateIsVerified not implemented")
}
func (UnimplementedUserCommandServiceServer) UpdatePassword(context.Context, *UpdateUserPasswordRequest) (*ApiResponseUser, error) {
...
func _UserCommandService_UpdateIsVerified_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateUserIsVerifiedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCommandServiceServer).UpdateIsVerified(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCommandService_UpdateIsVerified_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCommandServiceServer).UpdateIsVerified(ctx, req.(*UpdateUserIsVerifiedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserCommandService_UpdatePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateUserPasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCommandServiceServer).UpdatePassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCommandService_UpdatePassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCommandServiceServer).UpdatePassword(ctx, req.(*UpdateUserPasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserCommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.UserCommandService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateIsVerified",
			Handler:    _UserCommandService_UpdateIsVerified_Handler,
		},
		{
			MethodName: "UpdatePassword",
			Handler:    _UserCommandService_UpdatePassword_Handler,
		},
		{
