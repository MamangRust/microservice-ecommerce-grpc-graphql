...
const (
	TransactionCommandService_Create_FullMethodName                            = "/pb.TransactionCommandService/Create"
	TransactionCommandService_Update_FullMethodName                            = "/pb.TransactionCommandService/Update"
	TransactionCommandService_TrashedTransaction_FullMethodName                = "/pb.TransactionCommandService/TrashedTransaction"
	TransactionCommandService_RestoreTransaction_FullMethodName                = "/pb.TransactionCommandService/RestoreTransaction"
	TransactionCommandService_DeleteTransactionPermanent_FullMethodName        = "/pb.TransactionCommandService/DeleteTransactionPermanent"
	TransactionCommandService_RestoreAllTransaction_FullMethodName             = "/pb.TransactionCommandService/RestoreAllTransaction"
	TransactionCommandService_DeleteTransactionByOrderPermanent_FullMethodName = "/pb.TransactionCommandService/DeleteTransactionByOrderPermanent"
	TransactionCommandService_DeleteAllTransactionPermanent_FullMethodName     = "/pb.TransactionCommandService/DeleteAllTransactionPermanent"
)
...
type TransactionCommandServiceClient interface {
	...
	DeleteTransactionByOrderPermanent(ctx context.Context, in *FindByIdTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransactionDelete, error)
...
func (c *transactionCommandServiceClient) Create(ctx context.Context, in *CreateTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionCommandServiceClient) Update(ctx context.Context, in *UpdateTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransaction)
	err := c.cc.Invoke(ctx, TransactionCommandService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionCommandServiceClient) DeleteTransactionByOrderPermanent(ctx context.Context, in *FindByIdTransactionRequest, opts ...grpc.CallOption) (*ApiResponseTransactionDelete, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransactionDelete)
	err := c.cc.Invoke(ctx, TransactionCommandService_DeleteTransactionByOrderPermanent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionCommandServiceServer interface {
	...
	DeleteTransactionByOrderPermanent(context.Context, *FindByIdTransactionRequest) (*ApiResponseTransactionDelete, error)
...
func (UnimplementedTransactionCommandServiceServer) Create(context.Context, *CreateTransactionRequest) (*ApiResponseTransaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedTransactionCommandServiceServer) Update(context.Context, *UpdateTransactionRequest) (*ApiResponseTransaction, error) {
...
func (UnimplementedTransactionCommandServiceServer) DeleteTransactionByOrderPermanent(context.Context, *FindByIdTransactionRequest) (*ApiResponseTransactionDelete, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTransactionByOrderPermanent not implemented")
}
...
func _TransactionCommandService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).Create(ctx, req.(*CreateTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TransactionCommandService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).Update(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).Update(ctx, req.(*UpdateTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TransactionCommandService_DeleteTransactionByOrderPermanent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindByIdTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionCommandServiceServer).DeleteTransactionByOrderPermanent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionCommandService_DeleteTransactionByOrderPermanent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionCommandServiceServer).DeleteTransactionByOrderPermanent(ctx, req.(*FindByIdTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionCommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.TransactionCommandService",
	HandlerType: (*TransactionCommandServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Create",
			Handler:    _TransactionCommandService_Create_Handler,
		},
		{
			MethodName: "Update",
			Handler:    _TransactionCommandService_Update_Handler,
		},
		{
		...
		{
			MethodName: "DeleteTransactionByOrderPermanent",
			Handler:    _TransactionCommandService_DeleteTransactionByOrderPermanent_Handler,
		},
		{
