...
const (
	RoleCommandService_CreateRole_FullMethodName             = "/pb.RoleCommandService/CreateRole"
	RoleCommandService_UpdateRole_FullMethodName             = "/pb.RoleCommandService/UpdateRole"
	RoleCommandService_TrashedRole_FullMethodName            = "/pb.RoleCommandService/TrashedRole"
	RoleCommandService_RestoreRole_FullMethodName            = "/pb.RoleCommandService/RestoreRole"
	RoleCommandService_DeleteRolePermanent_FullMethodName    = "/pb.RoleCommandService/DeleteRolePermanent"
	RoleCommandService_RestoreAllRole_FullMethodName         = "/pb.RoleCommandService/RestoreAllRole"
	RoleCommandService_DeleteAllRolePermanent_FullMethodName = "/pb.RoleCommandService/DeleteAllRolePermanent"
	RoleCommandService_AssignRoleToUser_FullMethodName       = "/pb.RoleCommandService/AssignRoleToUser"
	RoleCommandService_RemoveRoleFromUser_FullMethodName     = "/pb.RoleCommandService/RemoveRoleFromUser"
)
...
type RoleCommandServiceClient interface {
	...
	AssignRoleToUser(ctx context.Context, in *AssignRoleToUserRequest, opts ...grpc.CallOption) (*ApiResponseUserRole, error)
...
func (c *roleCommandServiceClient) AssignRoleToUser(ctx context.Context, in *AssignRoleToUserRequest, opts ...grpc.CallOption) (*ApiResponseUserRole, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseUserRole)
	err := c.cc.Invoke(ctx, RoleCommandService_AssignRoleToUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roleCommandServiceClient) RemoveRoleFromUser(ctx context.Context, in *RemoveRoleFromUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, RoleCommandService_RemoveRoleFromUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoleCommandServiceServer interface {
	...
	AssignRoleToUser(context.Context, *AssignRoleToUserRequest) (*ApiResponseUserRole, error)
...
func (UnimplementedRoleCommandServiceServer) AssignRoleToUser(context.Context, *AssignRoleToUserRequest) (*ApiResponseUserRole, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AssignRoleToUser not implemented")
}
func (UnimplementedRoleCommandServiceServer) RemoveRoleFromUser(context.Context, *RemoveRoleFromUserRequest) (*emptypb.Empty, error) {
...
func _RoleCommandService_AssignRoleToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignRoleToUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoleCommandServiceServer).AssignRoleToUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleCommandService_AssignRoleToUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleCommandServiceServer).AssignRoleToUser(ctx, req.(*AssignRoleToUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoleCommandService_RemoveRoleFromUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveRoleFromUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoleCommandServiceServer).RemoveRoleFromUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleCommandService_RemoveRoleFromUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleCommandServiceServer).RemoveRoleFromUser(ctx, req.(*RemoveRoleFromUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoleCommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.RoleCommandService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RoleCommandService_AssignRoleToUser_Handler,
		},
		{
			MethodName: "RemoveRoleFromUser",
			Handler:    _RoleCommandService_RemoveRoleFromUser_Handler,
		},
	},
