...
const (
	UserQueryService_FindAll_FullMethodName                = "/pb.UserQueryService/FindAll"
	UserQueryService_FindById_FullMethodName               = "/pb.UserQueryService/FindById"
	UserQueryService_FindByEmail_FullMethodName            = "/pb.UserQueryService/FindByEmail"
	UserQueryService_FindByVerificationCode_FullMethodName = "/pb.UserQueryService/FindByVerificationCode"
	UserQueryService_FindByActive_FullMethodName           = "/pb.UserQueryService/FindByActive"
	UserQueryService_FindByTrashed_FullMethodName          = "/pb.UserQueryService/FindByTrashed"
)
...
func (UnimplementedUserQueryServiceServer) FindByVerificationCode(context.Context, *FindByVerificationCodeRequest) (*ApiResponseUser, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindByVerificationCode not implemented")
}
...
var UserQueryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.UserQueryService",
