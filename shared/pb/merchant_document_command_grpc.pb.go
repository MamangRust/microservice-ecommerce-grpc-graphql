...
const (
	MerchantDocumentCommandService_Create_FullMethodName             = "/pb.MerchantDocumentCommandService/Create"
	MerchantDocumentCommandService_Update_FullMethodName             = "/pb.MerchantDocumentCommandService/Update"
	MerchantDocumentCommandService_UpdateStatus_FullMethodName       = "/pb.MerchantDocumentCommandService/UpdateStatus"
	MerchantDocumentCommandService_Trashed_FullMethodName            = "/pb.MerchantDocumentCommandService/Trashed"
	MerchantDocumentCommandService_Restore_FullMethodName            = "/pb.MerchantDocumentCommandService/Restore"
	MerchantDocumentCommandService_DeletePermanent_FullMethodName    = "/pb.MerchantDocumentCommandService/DeletePermanent"
	MerchantDocumentCommandService_RestoreAll_FullMethodName         = "/pb.MerchantDocumentCommandService/RestoreAll"
	MerchantDocumentCommandService_DeleteAllPermanent_FullMethodName = "/pb.MerchantDocumentCommandService/DeleteAllPermanent"
)
...
func (c *merchantDocumentCommandServiceClient) Trashed(ctx context.Context, in *TrashedMerchantDocumentRequest, opts ...grpc.CallOption) (*ApiResponseMerchantDocument, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseMerchantDocument)
...
func (c *merchantDocumentCommandServiceClient) Restore(ctx context.Context, in *RestoreMerchantDocumentRequest, opts ...grpc.CallOption) (*ApiResponseMerchantDocument, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseMerchantDocument)
...
func (c *merchantDocumentCommandServiceClient) DeletePermanent(ctx context.Context, in *DeleteMerchantDocumentPermanentRequest, opts ...grpc.CallOption) (*ApiResponseMerchantDocumentDelete, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMerchantDocumentCommandServiceServer) Trashed(context.Context, *TrashedMerchantDocumentRequest) (*ApiResponseMerchantDocument, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Trashed not implemented")
}
func (UnimplementedMerchantDocumentCommandServiceServer) Restore(context.Context, *RestoreMerchantDocumentRequest) (*ApiResponseMerchantDocument, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Restore not implemented")
}
func (UnimplementedMerchantDocumentCommandServiceServer) DeletePermanent(context.Context, *DeleteMerchantDocumentPermanentRequest) (*ApiResponseMerchantDocumentDelete, error) {
...
func _MerchantDocumentCommandService_Trashed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantDocumentCommandServiceServer).Trashed(ctx, req.(*TrashedMerchantDocumentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MerchantDocumentCommandService_Restore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantDocumentCommandServiceServer).Restore(ctx, req.(*RestoreMerchantDocumentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MerchantDocumentCommandService_DeletePermanent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MerchantDocumentCommandServiceServer).DeletePermanent(ctx, req.(*DeleteMerchantDocumentPermanentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MerchantDocumentCommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.MerchantDocumentCommandService",
